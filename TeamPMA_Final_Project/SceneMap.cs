...
public class SceneMap : Scene
{
    ...
    public override void LoadContent()
    {
        ...
        starButton = new ToggleButton(starOnTex, starOffTex, new Rectangle(300, 580, 40, 40), _buttonClickSound);
    ...
    public override void Draw(SpriteBatch spriteBatch)
    {
        ...
        Vector2 instructionPos1 = new Vector2(20, Game.Graphics.PreferredBackBufferHeight - 60);
        Vector2 instructionPos2 = new Vector2(20, Game.Graphics.PreferredBackBufferHeight - 30);

        spriteBatch.DrawString(_uiFont, "Press D1 to Map", instructionPos1, Color.Black);
        spriteBatch.DrawString(_uiFont, "Press D2 to Favorites List", instructionPos2, Color.Black);
    ...
    {
        Rectangle popupRect = new Rectangle(30, 570, 320, 110);
